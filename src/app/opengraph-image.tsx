  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#0A090E", color: "white", padding: "74px", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", marginTop: 116, fontSize: 72, letterSpacing: -4, fontWeight: 700, lineHeight: 0.96 }}><span>Building ideas</span><span>into <span style={{ color: "#C9AAFF", fontFamily: "Georgia, serif", fontWeight: 400 }}>momentum.</span></span></div>
        <div style={{ display: "flex", marginTop: 29, color: "#BBB4C5", fontSize: 24 }}>Progress notes from the workbench.</div>
      </div>
