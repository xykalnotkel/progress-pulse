  ...
  return (
    <main className="pulse-shell" data-theme={dark ? "dark" : "light"}>
      ...
      <nav className="topbar">
        <Link className="brand" href="/" aria-label="XySpace Blog home"><span className="brand-orb"><i /></span><span>XySpace <span className="brand-blog">Blog</span></span></Link>
      ...
      <footer><Link className="brand" href="/"><span className="brand-orb"><i /></span><span>XySpace <span className="brand-blog">Blog</span></span></Link><span>© 2026 — made with intent</span><div><Link href="/">Back to home ↑</Link></div></footer>
